...
class ContextHead(nn.Module):
    def __init__(self, num_layers=1):
        ...
        self.num_layers = num_layers
        assert num_layers in [1, 2]
        self.layer1 = nn.Conv2d(512, 512, kernel_size=1, bias=True)
        self.dropout = nn.Dropout2d(p=0.1)
        self.layer2 = nn.Conv2d(512, 150, kernel_size=1, bias=True)
...
class UPerNet(nn.Module):
    ...
    def forward(self, x, y=None, context=None):
        ...
        if self.learn_context:
            ...
            context_loss = nn.BCELoss()(context_pred, context)
...
if __name__ == "__main__":
    ...
    model = UPerNet(backbone="resnet", init_weights="uper_film_resnet_cls_2.pth")
